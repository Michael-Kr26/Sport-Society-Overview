...
// Alleen bootstrap-masterdata die nodig is om een lege database bruikbaar te maken.
// Medewerkers, contracten, aliases en account-scopes worden nooit vanuit code geseed.
...
// Behouden als lege compatibility-exports. Persoonsgebonden data hoort in SQLite.
...
async function ensureMasterdataSchema(db) {
    await exec(db, `
        ...
        -- Legacy-tabellen blijven bestaan zodat bestaande databases leesbaar blijven,
        -- maar de migratie vult of activeert ze niet meer vanuit persoonsgebonden code-seeds.
...
// Compatibilityfunctie: persoonsgebonden access-scopes worden niet meer automatisch
// uit namen afgeleid. Bestaande user_location_scopes in SQLite blijven intact.
async function applyKnownAccessScopes() {
    return { applied: [], unresolved: [], roleMismatches: [] };
}
